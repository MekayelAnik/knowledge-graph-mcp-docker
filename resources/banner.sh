...
# Print ASCII art
print_ascii_art() {
    printf "${NAVY_BLUE} SS\   SS\                                   SS\                 SS\                            SSSSSS\                               SS\        ${NC} \n"
    printf "${NAVY_BLUE} SS | SS  |                                  SS |                SS |                          SS  __SS\                              SS |       ${NC} \n"
    printf "${NAVY_BLUE} SS |SS  / SSSSSSS\   SSSSSS\  SS\  SS\  SS\ SS | SSSSSS\   SSSSSSS | SSSSSS\   SSSSSS\        SS /  \__| SSSSSS\  SSSSSS\   SSSSSS\  SSSSSSS\   ${NC} \n"
    printf "${NAVY_BLUE} SSSSS  /  SS  __SS\ SS  __SS\ SS | SS | SS |SS |SS  __SS\ SS  __SS |SS  __SS\ SS  __SS\       SS |SSSS\ SS  __SS\ \____SS\ SS  __SS\ SS  __SS\  ${NC} \n"
    printf "${NAVY_BLUE} SS  SS<   SS |  SS |SS /  SS |SS | SS | SS |SS |SSSSSSSS |SS /  SS |SS /  SS |SSSSSSSS |      SS |\_SS |SS |  \__|SSSSSSS |SS /  SS |SS |  SS | ${NC} \n"
    printf "${NAVY_BLUE} SS |\SS\  SS |  SS |SS |  SS |SS | SS | SS |SS |SS   ____|SS |  SS |SS |  SS |SS   ____|      SS |  SS |SS |     SS  __SS |SS |  SS |SS |  SS | ${NC} \n"
    printf "${NAVY_BLUE} SS | \SS\ SS |  SS |\SSSSSS  |\SSSSS\SSSS  |SS |\SSSSSSS\ \SSSSSSS |\SSSSSSS |\SSSSSSS\       \SSSSSS  |SS |     \SSSSSSS |SSSSSSS  |SS |  SS | ${NC} \n"
    printf "${NAVY_BLUE} \__|  \__|\__|  \__| \______/  \_____\____/ \__| \_______| \_______| \____SS | \_______|       \______/ \__|      \_______|SS  ____/ \__|  \__| ${NC} \n"
    printf "${NAVY_BLUE}                                                                     SS\   SS |                                             SS |                 ${NC} \n"
    printf "${NAVY_BLUE}                                                                     \SSSSSS  |                                             SS |                 ${NC} \n"
    printf "${NAVY_BLUE}                                                                      \______/                                              \__|                 ${NC} \n"
